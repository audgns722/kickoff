...
//     try {
//         const apiKey = config.apiKey; // dev.js 파일에서 apiKey 가져오기
//         const newsApiUrl = `https://newsapi.org/v2/top-headlines?country=kr&apiKey=${apiKey}`;

//         const response = await axios.get(newsApiUrl);
//         res.status(200).json(response.data);
//     } catch (error) {
//         console.error('Error fetching news:', error);
//         res.status(500).json({ success: false, message: '뉴스 데이터를 가져오는 데 실패했습니다.' });
//     }
// })
...
//         // const newsApiUrl = `https://newsapi.org/v2/top-headlines?country=kr&apiKey=${apiKey}`;
//         const newsApiUrl = `https://newsapi.org/v2/top-headlines?country=kr&category=sports&apiKey=${apiKey}`
